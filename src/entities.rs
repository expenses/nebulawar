...
pub fn add_starting_entities(world: &mut World, rng: &mut ThreadRng) {
    ...
    for i in 0..50 {
        ...
        let fighter = create_ship(
            world,
            ShipType::Fighter,
            Vector3::new(x, 5.0, 0.0),
            Quaternion::zero(),
            Side::Friendly,
        );
    ...
    for i in 0..2 {
        create_ship(
            world,
            ShipType::Miner,
            Vector3::new(0.0, 2.5 - i as f32 * 15.0, 30.0),
            Quaternion::zero(),
            Side::Friendly,
        );
    }
    ...
    create_ship(
        ...
        Quaternion::between_vectors(UP, uniform_sphere_distribution(rng)),
        Side::Enemy,
    );
}
